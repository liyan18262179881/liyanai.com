...
const caseData = {
  agent: {
    ...
    metrics: [["核心指标", "单次流调 90 分钟 → 40 分钟"], ["北极星指标", "信息采集完整率 85%"], ["产品价值", "让 AI 在合规场景里稳定辅助一线调查"]],
    flow: [["01", "现场跟访与痛点拆解"], ["02", "Prompt 四层架构与多轮状态机"], ["03", "NER + LLM 校验与传播链建模"], ["04", "低分样本回捞与两周迭代闭环"]],
  },
  rag: {
    kicker: "案例 02", title: "AI 电子胸牌系统",
    desc: "面向应急演练前线救援人员，设计集动态身份展示、任务状态、GPS 感知、AI 动态提醒和一键求援于一体的智能 Agent App，从立项到 MVP 独立交付仅 2 个月。",
    link: "./cases/rag.html",
    metrics: [["核心指标", "覆盖 6 支救援队、60 台设备，3 次演练验证"], ["北极星指标", "弱网环境下核心流程完整可用"], ["产品价值", "把高压现场应急响应变为可记录、可协同的 Agent 产品"]],
  ...
  growth: {
    ...
    metrics: [["核心指标", "笔记生成成功率 92%"], ["北极星指标", "用户付费转化率 18%"], ["产品价值", "把 AIGC 生成效率转成可验证的商业闭环"]],
    flow: [["01", "竞品分析与 MVP 功能清单"], ["02", "标题、正文、标签 Prompt 工程"], ["03", "垂直场景模型微调与效果评估"], ["04", "3 个月内协同研发设计算法上线"]],
  },
};
...
const aiChatAnswers = {
  ...
  hardcase: "最难的案例是 AI 传染病调查系统。难点在于场景高压、数据敏感、政府合规要求高，还要让一线调查人员真的愿意用。她通过现场跟访拆解痛点，设计多轮对话状态机和 Prompt 四层架构，并建立 500+ 条脱敏评估集，最终把单次流调从 90 分钟压缩到 40 分钟。",
  ...
  projects: "她的代表项目有三个：AI 传染病调查系统（疾控政务，LLM+RAG+ASR 私有化部署，流调效率提升 50%）、AI 电子胸牌系统（应急救援 Agent App，2 个月独立交付 MVP，3 次演练验证）、AI 小红书营销内容生成（AIGC 营销工具，付费转化 18%）。",
  ...
  default: "这个问题我可以从她的简历信息里回答：她是 6 年产品经验、2 年 AI 产品经验的 AI 产品经理，核心优势是 0→1 落地、AI 产品全链路能力、评估驱动和跨团队交付。代表项目包括 AI 传染病调查系统、AI 电子胸牌系统和 AI 营销内容生成平台。你可以问我：最擅长什么、最难的案例、工作经历、适合创业公司吗。",
};
