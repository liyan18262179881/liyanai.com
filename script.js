...
const aiChatAnswers = {
  ...
  default: "这个问题我可以从她的简历信息里回答：她是 6 年产品经验、3 年 AI 产品经验的 AI 产品经理，核心优势是 0→1 落地、AI 产品全链路能力、评估驱动和跨团队交付。代表项目包括 AI 传染病调查系统、AI 电子胸牌系统和 AI 营销内容生成平台。你可以问我：最擅长什么、最难的案例、工作经历、适合创业公司吗。",
};
